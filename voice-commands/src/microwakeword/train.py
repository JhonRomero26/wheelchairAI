...
def validate_nonstreaming(config, data_processor, model, test_set):
    ...
    testing_ground_truth = to_categorical(testing_ground_truth, num_classes=num_classes)
    ...
    if data_processor.get_mode_size("validation_ambient") > 0:
        ...
        ambient_testing_ground_truth = to_categorical(ambient_testing_ground_truth, num_classes=num_classes)
